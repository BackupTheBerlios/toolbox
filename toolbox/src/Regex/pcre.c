...
//void *(*pcre_malloc)(size_t) = tb_xmalloc;
//void  (*pcre_free)(void *) = tb_xfree;
...
if (re->top_backref > 0 && re->top_backref >= ocount/3)
  ...
  match_block.offset_vector = (int *)tb_xmalloc(ocount * sizeof(int));
...
do
  ...
  if (using_temporary_offsets)
    ...
    tb_xfree(match_block.offset_vector);
    }
